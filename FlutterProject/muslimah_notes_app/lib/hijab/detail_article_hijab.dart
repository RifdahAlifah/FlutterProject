...
class DetailScreenHijab extends StatelessWidget {
  final ArtikelHijab artikelhijab;

  const DetailScreenHijab({@required this.artikelhijab});
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                Image.asset(artikelhijab.photo, width: 360.0, height: 180.0, fit: BoxFit.cover),
                SafeArea(
                  child: Row(
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 8.0),
                      Text(artikelhijab.author, style: authorTitle)
                    ],
                  ),
                  Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 8.0),
                      Text(artikelhijab.date, style: authorTitle)
                    ],
                  )
                ],
              ),
            ...
            Container(
              ...
              child: Text(
                artikelhijab.detail,textAlign: TextAlign.justify,
